<?php 
    ...
    // Obtener el nombre de la especialidad desde la base de datos
...
$nombreEspecialidad = ""; // Definir un valor por defecto si no se encontró la especialidad
}
?>
<!DOCTYPE html>
<html lang="es">
    <head>
        <title> PAGINA CIATAS MEDICAS</title>
        <meta charset="UTF-8">
...
<div id="banner-wrapper">
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-md-3">
                            <h1>INGRESAR DATOS</h1>
                                <form action="Acita.php" method="POST">                      
                                                
                                    <input type="text" class="form-control mb-3" name="id_cita" placeholder="Numero de reserva">              
                                    <input type="date" class="form-control mb-3" name="fecha" placeholder="Fecha reserva">
                                    <input type="text" class="form-control mb-3" name="turno" placeholder="Turno">
                                    <input type="text" class="form-control mb-3" name="nombre" placeholder="Especialidad" value="<?php echo $nombreEspecialidad; ?>">
                                    <input type="text" class="form-control mb-3" name="id_cliente" placeholder="Cliente">
                                ...
                                <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <th><a href="/cita/Ecita.php?id_cita=<?php echo $row['id_cita'] ?>" class="btn btn-info">Editar</a></th>
                                                <th><a href="Bcita.php?id_cita=<?php echo $row['id_cita'] ?>" class="btn btn-danger">Eliminar</a></th>                                        
                                            </tr>
                                        <?php 
                                            }
                                        ?>
  ...
  <footer class="second-footer">
    <p>
      &copy; <a href="clinicadental">ClinicaDental.com</a>
    </p>
  </footer>
  <script>
