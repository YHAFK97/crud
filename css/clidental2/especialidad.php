                    ...
                    <div class="row"> 
                        ...
                        <div class="col-md-3">
                            <h1>INGRESAR DATOS</h1>
                                <form action="/especialidad/Aespecialidad.php" method="POST">              
                                                                    
                                    <input type="text" class="form-control mb-3" name="id_especialidad" placeholder="Id Especialidad">               
                                    <input type="text" class="form-control mb-3" name="nombre" placeholder="Ingrese la especialidad">
                                ...
                                <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <th><a href="/especialidad/Eespecialidad.php?id_especialidad=<?php echo $row['id_especialidad'] ?>" class="btn btn-info">Editar</a></th>
                                                <th><a href="/especialidad/Bespecialidad.php?id_especialidad=<?php echo $row['id_especialidad'] ?>" class="btn btn-danger">Eliminar</a></th>                                        
                                            </tr>
                                        <?php 
                                            }
                                        ?>
