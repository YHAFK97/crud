...
<html lang="es">
    <head>
        <title> PAGINA HISTORIA CLINICA</title>
        <meta charset="UTF-8">
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-md-3">
                            <h1>INGRESAR DATOS</h1>
                                <form action="Ahistoria.php" method="POST">                                 
                                    <input type="date" class="form-control mb-3" name="fecha_apertura" placeholder="Fecha Apertura">
                                    <input type="int" class="form-control mb-3" name="id_cliente" placeholder="Numero de Cliente">
                                    <input type="int" class="form-control mb-3" name="id_personal" placeholder="N de Personal">
                        ...
                        <div class="col-md-8">
                            <table class="table" >
                                ...
                                <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <th><?php  echo $row['id_historia']?></th>
                                                <th><?php  echo $row['fecha_apertura']?></th>
                                                <th><?php  echo $row['id_cliente']?></th>
                                                <th><?php  echo $row['id_personal']?></th>    
                                                <th><?php  echo $row['descripcion']?></th>
                                                <th><a href="Ehistoria.php?id_historia=<?php echo $row['id_historia'] ?>" class="btn btn-info">Editar</a></th>
                                                <th><a href="Bhistoria.php?id_historia=<?php echo $row['id_historia'] ?>" class="btn btn-danger">Eliminar</a></th>                                        
                                            </tr>
                                        <?php 
                                            }
                                        ?>
