                                ...
                                <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <th><a href="Ecliente.php?id_cliente=<?php echo $row['id_cliente'] ?>" class="btn btn-info">Editar</a></th>
                                                <th><a href="Bcliente.php?id_cliente=<?php echo $row['id_cliente'] ?>" class="btn btn-danger">Eliminar</a></th>                                        
                                            </tr>
                                        <?php 
                                            }
                                        ?>
