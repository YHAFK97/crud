                    ...
                    <div class="row"> 
                        ...
                        <div class="col-md-3">
                            <h1>INGRESAR DATOS</h1>
                                <form action="Acargo.php" method="POST">    
                                    <input type="text" class="form-control mb-3" name="id_cargo" placeholder="Id de cargo">                                
                                    <input type="text" class="form-control mb-3" name="cargo" placeholder="Ocupacion">
                                ...
                                <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <th><a href="Ecargo.php?id_cargo=<?php echo $row['id_cargo'] ?>" class="btn btn-info">Editar</a></th>
                                                <th><a href="Bcargo.php?id_cargo=<?php echo $row['id_cargo'] ?>" class="btn btn-danger">Eliminar</a></th>                                        
                                            </tr>
                                        <?php 
                                            }
                                        ?>
